...
public class InfoJsonHelper {
    ...
    private static final String TAG = InfoJsonHelper.class.getSimpleName();
        ...
        while (iteratorSource.hasNext()) {
            try {
                ...
                if (destination.has(name)) {
                    ...
                    Log.d(TAG, "name has duplicated, check it out: " + name + ", " + v + " -> " + value);
                }
        ...
        while (iteratorSource.hasNext()) {
            try {
                ...
                if (destination.has(name)) {
                    ...
                    if (!isEqual) {
                        Log.d(TAG, "name has duplicated, and values are not the same: " + name + ", " + v + " -> " + value);
                    }
