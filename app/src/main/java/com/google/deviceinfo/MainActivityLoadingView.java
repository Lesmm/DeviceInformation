...
public class MainActivityLoadingView extends RelativeLayout {
    ...
    public MainActivityLoadingView(Context context) {
        this(context, null);
    }

    public MainActivityLoadingView(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MainActivityLoadingView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
